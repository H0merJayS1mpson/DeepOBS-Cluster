...
* [Custom Deepobs](https://github.com/H0merJayS1mpson/deepobscustom) - The DNN Optimizer Benchmark suite modified to be able to run the PAL Optimizer (see [PAL-Optimizer](https://github.com/cogsys-tuebingen/PAL) for further information) as well as allowing to modify the testproblems by altering the weight initializations of the testproblems DNN.
